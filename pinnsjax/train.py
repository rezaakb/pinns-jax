...
def train(
    ...
    if cfg.net._target_ == "pinnsjax.models.FCN":
    ...
    elif cfg.net._target_ == "pinnsjax.models.NetHFM":
        # TODO
        log.info(f"Instantiating neural net <{cfg.net._target_}>")
